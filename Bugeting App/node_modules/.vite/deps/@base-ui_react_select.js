...
import {
  ...
  useDirection
} from "./chunk-BKCNQEFE.js";
import {
  useButton
} from "./chunk-BI63IISJ.js";
import {
  Timeout,
  ...
  useLabelableId,
  useTimeout
} from "./chunk-DLJ67QZT.js";
import "./chunk-3XIB7XCW.js";
import {
  ACTIVE_KEY,
  ARROW_DOWN,
  ARROW_LEFT,
  ...
  useTransitionStatus
} from "./chunk-SLDZUASG.js";
import {
  useBaseUiId,
  useId
} from "./chunk-TO65A4UE.js";
import {
...
var ReactStore = class extends Store {
  ...
  useSyncedValues(statePart) {
    const store = this;
    if (true) {
      React4.useDebugValue(statePart, (p) => Object.keys(p));
      const keys = React4.useRef(Object.keys(statePart)).current;
...
var FloatingDelayGroupContext = React6.createContext({
  hasProvider: false,
  timeoutMs: 0,
  delayRef: {
    current: 0
...
var FocusGuard = React7.forwardRef(function FocusGuard2(props, ref) {
  const [role, setRole] = React7.useState();
  useIsoLayoutEffect(() => {
    if (isSafari) {
      setRole("button");
    }
...
var PortalContext = React8.createContext(null);
if (true) PortalContext.displayName = "PortalContext";
var usePortalContext = () => React8.useContext(PortalContext);
...
function useFloatingPortalNode(props = {}) {
  ...
  const [containerElement, setContainerElement] = React8.useState(null);
  const [portalNode, setPortalNode] = React8.useState(null);
...
var FloatingPortal = React8.forwardRef(function FloatingPortal2(componentProps, forwardedRef) {
  const {
    children,
    container,
    className,
  ...
  const beforeOutsideRef = React8.useRef(null);
  const afterOutsideRef = React8.useRef(null);
  const beforeInsideRef = React8.useRef(null);
  const afterInsideRef = React8.useRef(null);
  const [focusManagerState, setFocusManagerState] = React8.useState(null);
  ...
  const portalContextValue = React8.useMemo(() => ({
    beforeOutsideRef,
    afterOutsideRef,
    beforeInsideRef,
    afterInsideRef,
  ...
  return (0, import_jsx_runtime4.jsxs)(React8.Fragment, {
    children: [portalSubtree, (0, import_jsx_runtime4.jsxs)(PortalContext.Provider, {
      ...
      }), portalNode && ReactDOM2.createPortal(children, portalNode), shouldRenderGuards && portalNode && (0, import_jsx_runtime4.jsx)(FocusGuard, {
        "data-type": "outside",
        ref: afterOutsideRef,
        onFocus: (event) => {
          var _a;
...
var FloatingNodeContext = React9.createContext(null);
if (true) FloatingNodeContext.displayName = "FloatingNodeContext";
var FloatingTreeContext = React9.createContext(null);
...
function FloatingFocusManager(props) {
  ...
  const orderRef = React10.useRef(["content"]);
  ...
  const pointerDownOutsideRef = React10.useRef(false);
  const tabbableIndexRef = React10.useRef(-1);
  const closeTypeRef = React10.useRef("");
  const lastInteractionTypeRef = React10.useRef("");
  const beforeGuardRef = React10.useRef(null);
  const afterGuardRef = React10.useRef(null);
  ...
  return (0, import_jsx_runtime6.jsxs)(React10.Fragment, {
    children: [shouldRenderGuards && (0, import_jsx_runtime6.jsx)(FocusGuard, {
      "data-type": "inside",
...
function useClick(context, props = {}) {
  ...
  const pointerTypeRef = React11.useRef(void 0);
...
function useDismiss(context, props = {}) {
  ...
  const pressStartedInsideRef = React13.useRef(false);
  const pressStartPreventedRef = React13.useRef(false);
  const suppressNextOutsideClickRef = React13.useRef(false);
  const {
    escapeKey: escapeKeyBubbles,
    outsidePress: outsidePressBubbles
  } = normalizeProp(bubbles);
  const touchStateRef = React13.useRef(null);
  ...
  const currentPointerTypeRef = React13.useRef("");
  ...
  React13.useEffect(clearInsideReactTree, [outsidePress, clearInsideReactTree]);
...
function useFloating2(options = {}) {
  ...
  const [positionReference, setPositionReferenceRaw] = React16.useState(null);
  ...
  const [localDomReference, setLocalDomReference] = React16.useState(null);
  const [localFloatingElement, setLocalFloatingElement] = React16.useState(null);
...
function useInteractions(propsList = []) {
  ...
  const getTriggerProps = React21.useCallback(
...
function useListNavigation(context, props) {
  ...
  const focusItemOnOpenRef = React22.useRef(focusItemOnOpen);
  const indexRef = React22.useRef(selectedIndex ?? -1);
  const keyRef = React22.useRef(null);
  const isPointerModalityRef = React22.useRef(true);
  const onNavigate = useStableCallback((event) => {
    onNavigateProp(indexRef.current === -1 ? null : indexRef.current, event);
  });
  const previousOnNavigateRef = React22.useRef(onNavigate);
  const previousMountedRef = React22.useRef(!!floatingElement);
  const previousOpenRef = React22.useRef(open);
  const forceSyncFocusRef = React22.useRef(false);
  const forceScrollIntoViewRef = React22.useRef(false);
  ...
  const getParentOrientation = React22.useCallback(() => {
    var _a, _b, _c;
  ...
  const ariaActiveDescendantProp = React22.useMemo(() => {
...
function useTypeahead(context, props) {
  ...
  const stringRef = React24.useRef("");
  const prevIndexRef = React24.useRef(selectedIndex ?? activeIndex ?? -1);
  const matchIndexRef = React24.useRef(null);
  useIsoLayoutEffect(() => {
  ...
  const onKeyDown = useStableCallback((event) => {
    ...
    const allowRapidSuccessionOfFirstLetter = listContent.every((text) => {
      var _a, _b;
      return text ? ((_a = text[0]) == null ? void 0 : _a.toLocaleLowerCase()) !== ((_b = text[1]) == null ? void 0 : _b.toLocaleLowerCase()) : true;
    });
...
var SelectRootContext = React25.createContext(null);
if (true) SelectRootContext.displayName = "SelectRootContext";
var SelectFloatingContext = React25.createContext(null);
if (true) SelectFloatingContext.displayName = "SelectFloatingContext";
function useSelectRootContext() {
  const context = React25.useContext(SelectRootContext);
  if (context === null) {
...
function useSelectFloatingContext() {
  const context = React25.useContext(SelectFloatingContext);
  if (context === null) {
...
function resolveMultipleLabels(values, items, itemToStringLabel) {
  return values.reduce((acc, value, index2) => {
    ...
    acc.push((0, import_jsx_runtime7.jsx)(React26.Fragment, {
...
function useEnhancedClickHandler(handler) {
  const lastClickInteractionTypeRef = React28.useRef("");
  ...
  const handleClick = React28.useCallback((event) => {
    if (event.detail === 0) {
...
function useOpenInteractionType(open) {
  const [openMethod, setOpenMethod] = React29.useState(null);
...
function SelectRoot(props) {
  ...
  const listRef = React30.useRef([]);
  const labelsRef = React30.useRef([]);
  const popupRef = React30.useRef(null);
  const scrollHandlerRef = React30.useRef(null);
  const scrollArrowsMountedCountRef = React30.useRef(0);
  const valueRef = React30.useRef(null);
  const valuesRef = React30.useRef([]);
  const typingRef = React30.useRef(false);
  const keyboardActiveRef = React30.useRef(false);
  const selectedItemTextRef = React30.useRef(null);
  const selectionRef = React30.useRef({
    allowSelectedMouseUp: false,
    allowUnselectedMouseUp: false
  });
  const alignItemWithTriggerActiveRef = React30.useRef(false);
  const {
    mounted,
    setMounted,
    transitionStatus
  ...
  const serializedValue = React30.useMemo(() => {
    if (multiple && Array.isArray(value) && value.length === 0) {
      return "";
    }
    return stringifyAsValue(value, itemToStringValue);
  }, [multiple, value, itemToStringValue]);
  const fieldStringValue = React30.useMemo(() => {
    if (multiple && Array.isArray(value)) {
  ...
  const initialValueRef = React30.useRef(value);
  useIsoLayoutEffect(() => {
  ...
  React30.useImperativeHandle(actionsRef, () => ({
  ...
  const mergedTriggerProps = React30.useMemo(() => {
  ...
  const hiddenInputs = React30.useMemo(() => {
    if (!multiple || !Array.isArray(value) || !name) {
      return null;
    }
    return value.map((v) => {
      const currentSerializedValue = stringifyAsValue(v, itemToStringValue);
      return (0, import_jsx_runtime8.jsx)("input", {
        type: "hidden",
        name,
  ...
  return (0, import_jsx_runtime8.jsx)(SelectRootContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime8.jsxs)(SelectFloatingContext.Provider, {
      value: floatingContext,
      children: [children, (0, import_jsx_runtime8.jsx)("input", {
...
// node_modules/@base-ui/react/esm/select/label/SelectLabel.js
var SelectLabel = React31.forwardRef(function SelectLabel2(componentProps, forwardedRef) {
  const {
    render,
    className,
    ...elementProps
  ...
  const labelProps = useLabel({
    id: defaultLabelId,
    fallbackControlId: (triggerElement == null ? void 0 : triggerElement.id) ?? rootId,
...
var SelectTrigger = React32.forwardRef(function SelectTrigger2(componentProps, forwardedRef) {
  const {
    render,
    className,
    id: idProp,
  ...
  const ariaControlsId = React32.useMemo(() => {
    var _a;
...
var SelectValue = React33.forwardRef(function SelectValue2(componentProps, forwardedRef) {
  const {
    className,
    render,
...
var SelectIcon = React34.forwardRef(function SelectIcon2(componentProps, forwardedRef) {
  const {
    className,
    render,
    ...elementProps
...
var SelectPortalContext = React35.createContext(void 0);
if (true) SelectPortalContext.displayName = "SelectPortalContext";

// node_modules/@base-ui/react/esm/select/portal/SelectPortal.js
var import_jsx_runtime9 = __toESM(require_jsx_runtime(), 1);
var SelectPortal = React36.forwardRef(function SelectPortal2(portalProps, forwardedRef) {
  const {
    store
  } = useSelectRootContext();
  ...
  return (0, import_jsx_runtime9.jsx)(SelectPortalContext.Provider, {
    value: true,
...
var SelectBackdrop = React37.forwardRef(function SelectBackdrop2(componentProps, forwardedRef) {
  const {
    className,
    render,
    ...elementProps
...
var baseArrow = (options) => ({
  ...
  async fn(state) {
    ...
    const arrowOffsetParent = offsetParent === "real" ? await ((_a = platform2.getOffsetParent) == null ? void 0 : _a.call(platform2, element)) : elements.floating;
...
var hide4 = {
  ...
  async fn(state) {
    ...
    return {
      data: {
        referenceHidden: ((_a = nativeHideResult.data) == null ? void 0 : _a.referenceHidden) || anchorHidden
      }
    };
  }
};
...
var SelectPositionerContext = React39.createContext(void 0);
if (true) SelectPositionerContext.displayName = "SelectPositionerContext";
function useSelectPositionerContext() {
  const context = React39.useContext(SelectPositionerContext);
  if (!context) {
...
var InternalBackdrop = React40.forwardRef(function InternalBackdrop2(props, ref) {
  const {
    cutout,
    ...otherProps
  } = props;
...
var SelectPositioner = React41.forwardRef(function SelectPositioner2(componentProps, forwardedRef) {
  const {
    anchor,
    positionMethod = "absolute",
    className,
  ...
  const transitionStatus = useStore(store, selectors2.transitionStatus);
  const scrollUpArrowRef = React41.useRef(null);
  const scrollDownArrowRef = React41.useRef(null);
  const [controlledAlignItemWithTrigger, setControlledAlignItemWithTrigger] = React41.useState(alignItemWithTrigger);
  ...
  React41.useImperativeHandle(alignItemWithTriggerActiveRef, () => alignItemWithTriggerActive);
  ...
  const defaultProps = React41.useMemo(() => {
    const hiddenStyles = {};
    if (!open) {
  ...
  const prevMapSizeRef = React41.useRef(0);
  ...
  return (0, import_jsx_runtime11.jsx)(CompositeList, {
    elementsRef: listRef,
    labelsRef,
    onMapChange,
    children: (0, import_jsx_runtime11.jsxs)(SelectPositionerContext.Provider, {
      value: contextValue,
      children: [mounted && modal && (0, import_jsx_runtime11.jsx)(InternalBackdrop, {
...
var styleDisableScrollbar = {
  ...
  getElement(nonce) {
    return (0, import_jsx_runtime12.jsx)("style", {
      nonce,
...
var ToolbarRootContext = React42.createContext(void 0);
if (true) ToolbarRootContext.displayName = "ToolbarRootContext";
function useToolbarRootContext(optional) {
  const context = React42.useContext(ToolbarRootContext);
...
var SelectPopup = React43.forwardRef(function SelectPopup2(componentProps, forwardedRef) {
  const {
    render,
    className,
    finalFocus,
  ...
  const positionerElement = useStore(store, selectors2.positionerElement);
  const listElement = useStore(store, selectors2.listElement);
  const initialHeightRef = React43.useRef(0);
  const reachedMaxHeightRef = React43.useRef(false);
  const maxHeightRef = React43.useRef(0);
  const initialPlacedRef = React43.useRef(false);
  const originalPositionerStylesRef = React43.useRef({});
  ...
  React43.useImperativeHandle(scrollHandlerRef, () => handleScroll, [handleScroll]);
  useOpenChangeComplete({
    open,
    ref: popupRef,
    onComplete() {
  ...
  useIsoLayoutEffect(() => {
    ...
    queueMicrotask(() => {
      ...
      try {
        ...
        const isPinchZoomed = (((_a = win.visualViewport) == null ? void 0 : _a.scale) ?? 1) !== 1 && isWebKit2;
  ...
  return (0, import_jsx_runtime13.jsxs)(React43.Fragment, {
    children: [!disableStyleElements && styleDisableScrollbar.getElement(nonce), (0, import_jsx_runtime13.jsx)(FloatingFocusManager, {
...
var SelectList = React44.forwardRef(function SelectList2(componentProps, forwardedRef) {
  const {
    className,
    render,
    ...elementProps
...
var SelectItemContext = React45.createContext(void 0);
if (true) SelectItemContext.displayName = "SelectItemContext";
function useSelectItemContext() {
  const context = React45.useContext(SelectItemContext);
  if (!context) {
...
var SelectItem = React46.memo(React46.forwardRef(function SelectItem2(componentProps, forwardedRef) {
  const {
    render,
    className,
  ...
  const textRef = React46.useRef(null);
  ...
  rootProps.id = void 0;
  const lastKeyRef = React46.useRef(null);
  const pointerTypeRef = React46.useRef("mouse");
  const didPointerDownRef = React46.useRef(false);
  const {
    getButtonProps,
    buttonRef
  } = useButton({
  ...
  const defaultProps = {
    ...
    onMouseUp() {
      ...
      (_a = itemRef.current) == null ? void 0 : _a.click();
    }
  };
  const element = useRenderElement("div", componentProps, {
  ...
  return (0, import_jsx_runtime14.jsx)(SelectItemContext.Provider, {
    value: contextValue,
    children: element
  });
}));
...
var SelectItemIndicator = React47.forwardRef(function SelectItemIndicator2(componentProps, forwardedRef) {
  ...
  return (0, import_jsx_runtime15.jsx)(Inner, {
    ...componentProps,
    ref: forwardedRef
  });
});
if (true) SelectItemIndicator.displayName = "SelectItemIndicator";
var Inner = React47.memo(React47.forwardRef((componentProps, forwardedRef) => {
  const {
    render,
    className,
    keepMounted,
  ...
  const indicatorRef = React47.useRef(null);
  const {
    transitionStatus,
    setMounted
...
var SelectItemText = React48.memo(React48.forwardRef(function SelectItemText2(componentProps, forwardedRef) {
  const {
    indexRef,
    textRef,
    selectedByFocus,
  ...
  const localRef = React48.useCallback((node) => {
...
var SelectArrow = React49.forwardRef(function SelectArrow2(componentProps, forwardedRef) {
  const {
    className,
    render,
    ...elementProps
...
var SelectScrollArrow = React50.forwardRef(function SelectScrollArrow2(componentProps, forwardedRef) {
  const {
    render,
    className,
    direction,
...
var SelectScrollDownArrow = React51.forwardRef(function SelectScrollDownArrow2(props, forwardedRef) {
  return (0, import_jsx_runtime16.jsx)(SelectScrollArrow, {
    ...props,
    ref: forwardedRef,
    direction: "down"
  });
...
var SelectScrollUpArrow = React52.forwardRef(function SelectScrollUpArrow2(props, forwardedRef) {
  return (0, import_jsx_runtime17.jsx)(SelectScrollArrow, {
    ...props,
    ref: forwardedRef,
    direction: "up"
  });
...
var SelectGroupContext = React53.createContext(void 0);
if (true) SelectGroupContext.displayName = "SelectGroupContext";
function useSelectGroupContext() {
  const context = React53.useContext(SelectGroupContext);
  if (context === void 0) {
...
var SelectGroup = React54.forwardRef(function SelectGroup2(componentProps, forwardedRef) {
  const {
    className,
    render,
    ...elementProps
  } = componentProps;
  const [labelId, setLabelId] = React54.useState();
  ...
  return (0, import_jsx_runtime18.jsx)(SelectGroupContext.Provider, {
    value: contextValue,
    children: element
  });
});
...
var SelectGroupLabel = React55.forwardRef(function SelectGroupLabel2(componentProps, forwardedRef) {
  const {
    className,
    render,
    id: idProp,
...
var Separator = React56.forwardRef(function SeparatorComponent(componentProps, forwardedRef) {
  const {
    className,
    render,
